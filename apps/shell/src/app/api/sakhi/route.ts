...
const RESPONSES: { keywords: string[]; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "भूख न लगना, कमज़ोरी, और चक्कर आना — ये तीनों मिलकर अक्सर एनीमिया (खून की कमी) या थायराइड असंतुलन के संकेत होते हैं। WHO के अनुसार, भारत में 57% महिलाओं में आयरन की कमी है जो इन लक्षणों का सबसे आम कारण है। ICMR की सिफारिश है कि CBC (Complete Blood Count) और TSH जांच से कारण का पता लगाया जा सकता है। इन लक्षणों को नज़रअंदाज़ न करें — ये सामान्य नहीं हैं।",
  },
  {
...
const DEFAULT =
  "इस विषय पर हमारे सत्यापित डेटाबेस में अभी जानकारी उपलब्ध नहीं है। आप पीरियड दर्द, PCOS, एनीमिया, थायराइड, रजोनिवृत्ति, या गर्भावस्था से जुड़े सवाल पूछ सकती हैं — इन पर सखी के पास WHO और FOGSI से सत्यापित जानकारी है।" +
  DISCLAIMER;
